# Create C++ -based Intel® IoT projects with the Grove Starter Kit
...
This guide will demonstrate how you can use C++ and the Grove Starter Kit with any Intel® IoT board to go beyond blinking the onboard LED.
...
* [Create Intel® IoT projects with the Grove Starter Kit - Part 2: C (preview)]()
...
* the Intel® IoT Eclipse IDE installed on your development computer
* the Grove Starter Kit for Arduino or Grove Starter Kit Plus - Intel IoT Edition

You also should have already completed the [Set Up IoT Dev Kit Eclipse »](/ide_setup-eclipse/setup.md) guide, and you can successfully blink the onboard LED on your Intel® Edison or Intel® Galileo.
...
Intel® maintains the [MRAA library on Github](https://github.com/intel-iot-devkit/mraa) and [API documentation on iotdk.intel.com](http://iotdk.intel.com/docs/master/mraa/).
...
Intel® maintains the UPM library on Github. For C++ code samples, look for your specific component on [software.intel.com/iot/hardware/sensors](http://software.intel.com/iot/hardware/sensors) or in the [examples → c++](https://github.com/intel-iot-devkit/upm/tree/master/examples/c++) folder in the [UPM Github repo](https://github.com/intel-iot-devkit/upm/).
