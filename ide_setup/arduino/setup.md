...
Now that you have installed the Arduino IDE, see [Blinking an LED with the Arduino IDE on the Intel® Edison Board](https://github.com/terminaltraces/getting-started-guides/blob/master/ide_setup/arduino/create_sketch.md) for steps to run a sample application to blink an LED on your board.
