...
You also should have already completed the [Set Up Intel XDK for IoT guide](../set_up_xdk/setup.md), and you can successfully blink the onboard LED on your Intel® Edison or Intel® Galileo.
